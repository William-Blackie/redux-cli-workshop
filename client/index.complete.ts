/**
 * Redux CLI Workshop: Client Application (COMPLETE VERSION)
 *
 * This is the complete implementation with all reducer cases filled in.
 * Use this for demos or as a reference.
 * 
 * To use this version: cp client/index.complete.ts client/index.ts
 * See PRESENTER.md for switching between exercise and complete modes.
 */
